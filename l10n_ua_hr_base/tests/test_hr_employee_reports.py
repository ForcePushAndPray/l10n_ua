...
class TestHrEmployeeReports(TestHrUaBase):
    ...
    def test_hr_employee_military_report(self):
        employee_1 = self._create_employee(name='Emp 1', military_status='liable')
        ...
        employee_3 = self._create_employee(name='Emp 3', military_status='reserved', military_reservation=True)
