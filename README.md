...
**Призначення:** Облік відпусток, лікарняних листів, е-ТВН відповідно до Закону України «Про відпустки» № 504/96-ВР та Постанови КМУ № 100.

#### Основні моделі:
- **hr.leave** — розширення заявки на відпустку
- **hr.leave.type** — типи відпусток за КЗпП
- **hr.vacation.balance** — баланс відпусток по роках
- **hr.sick.leave** — лікарняні листки (е-ТВН)
- **hr.vacation.schedule** — графік відпусток

#### Типи відпусток:
| Категорія | Опис | Днів |
|-----------|------|------|
| Щорічна основна | Мінімум 24 календарних дні | 24 |
| За шкідливі умови | Додаткова за шкідливі умови праці | до 35 |
| За ненормований день | Додаткова за ненормований робочий день | до 7 |
| За особливий характер праці | Додаткова за особливий характер роботи | до 7 |
| Соціальна (на дітей) | Додаткова працівникам з дітьми | 10 |
| Навчальна | Для здобуття освіти | залежно від рівня |
| Творча | Для завершення дисертації | до 6 міс. |
| Без збереження | За згодою сторін | до 15 |
| Декретна | Вагітність та пологи | 126-140 |
| По догляду за дитиною | До 3 (6) років | - |
| Чорнобильцям | Постраждалим від Чорнобиля | 16 |
| Ветеранам | Ветеранам війни | 14 |

#### Ключові правила обліку:
- **Святкові дні** — автоматично виключаються з тривалості відпустки
- **Перша відпустка** — через 6 місяців безперервної роботи
- **Мінімальна частина** — не менше 14 календарних днів
- **Перенесення** — не більше 2 років поспіль
- **Компенсація при звільненні** — за всі невикористані дні
- **Компенсація без звільнення** — тільки за дні понад 24

#### Розрахунок відпускних (Постанова КМУ № 100):
```
Відпускні = СДЗ × Кількість календарних днів
СДЗ = Заробіток за 12 міс. ÷ (Календарні дні − Святкові − Виключені періоди)
```

#### Лікарняні (е-ТВН):
| Страховий стаж | Відсоток оплати |
|----------------|-----------------|
| до 3 років | 50% |
| 3-5 років | 60% |
| 5-8 років | 70% |
...
- **Роботодавець** — перші 5 днів
- **ФСС** — з 6-го дня

#### Процеси:
1. **Оформлення відпустки:**
   - Заявка працівника → Перевірка стажу (6 міс.) → Перевірка залишку днів → Затвердження → Наказ про відпустку → Розрахунок відпускних
