...
У версії договору (`hr.version`) вид зайнятості задається одним полем — «Тип зайнятості»
(`employment_type_ua`: основне місце / внутрішнє / зовнішнє сумісництво):

| Поле (`hr.version`) | Значення |
|---------------------|----------|
| `employment_type_ua` (Тип зайнятості) | **Зовнішнє сумісництво** (`external`) |
...
- [x] **Сумісник:** `employment_type_ua=external` + `work_rate=0.5`
